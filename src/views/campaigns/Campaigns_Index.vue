...
export default {
  ...
  methods :{
    ...
    Items_Get(per_page,page){
      ...
      this.Module_Campaign_Action_Index({per_page:per_page,page:page,params:this.query_params}).then(res => {
    ...
    Item_Delete(id){
      ...
      this.Module_Campaign_Action_Delete(id).then(res => {
    ...
    Item_Activation(id){
      ...
      this.Module_Campaign_Action_Activation(id).then(res => {
        this.items = this.items.filter(item => {
          if (item.id === id){
