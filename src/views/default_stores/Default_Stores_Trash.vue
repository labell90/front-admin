...
export default {
  ...
  methods :{
    ...mapActions([
      "Module_Default_Stores_Trash_Index",
      "Module_Default_Stores_Restore_Delete",
      "Module_Default_Stores_Restore",
    ...
    Items_Get(per_page,page){
      ...
      this.Module_Default_Stores_Trash_Index({per_page:per_page,page:page}).then(res => {
    ...
    Item_Delete(id){
      ...
      this.Module_Default_Stores_Restore_Delete(id).then(res => {
    ...
    Item_Restore(id){
      this.delete_loading=true;
      this.Module_Default_Stores_Restore(id).then(res => {
        this.items = this.items.filter(item => {
          return item.id !== id;
        })
        this.Methods_Notify_Delete();
...
<template>
  <q-card>
    <q-card-section>
      ...
      <global_actions_header_buttons :create="true" route="default_stores"></global_actions_header_buttons>
