...
export default {
  ...
  methods :{
    ...mapActions([
      "Module_Production_Types_Index",
      "Module_Production_Types_Delete",
      "Module_Production_Types_Action_Activation",
    ...
    Items_Get(per_page,page){
      ...
      this.Module_Production_Types_Index({per_page:per_page,page:page,params:this.query_params}).then(res => {
    ...
    Searchable_Get(){
      this.Module_Production_Types_Searchable().then(res => {
    ...
    Item_Delete(id){
      ...
      this.Module_Production_Types_Delete(id).then(res => {
    ...
    Item_Activation(id){
      ...
      this.Module_Production_Types_Action_Activation(id).then(res => {
        this.items = this.items.filter(item => {
          if (item.id === id){
...
<template>
  <q-card>
    <q-card-section>
      <global_actions_header_buttons :create="true" :archive="true" route="production_types"></global_actions_header_buttons>
      <q-separator class="q-mt-xl"/>
      <q-separator class="q-mt-xl"/>
      <div class="q-mt-md">
        <strong class="text-teal-8">جستجو و فیلتر پبشرفته</strong>
        <div class="q-mt-sm">
        ...
        <template v-slot:body-cell-tools="props">
          <q-td :props="props">
            <div class="text-center">
              <q-btn :to="{name:'production_types_edit',params:{id:props.row.id}}" glossy title="ویرایش آیتم" class="q-ma-xs" color="blue-8" icon="fas fa-edit" size="9px" round  />
