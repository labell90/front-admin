...
export default {
  ...
  methods :{
    ...mapActions([
      "Module_Task_Types_Trash_Index",
      "Module_Task_Types_Restore_Delete",
      "Module_Task_Types_Restore",
    ...
    Items_Get(per_page,page){
      ...
      this.Module_Task_Types_Trash_Index({per_page:per_page,page:page}).then(res => {
    ...
    Item_Delete(id){
      ...
      this.Module_Task_Types_Restore_Delete(id).then(res => {
    ...
    Item_Restore(id){
      this.delete_loading=true;
      this.Module_Task_Types_Restore(id).then(res => {
        this.items = this.items.filter(item => {
          return item.id !== id;
        })
        this.Methods_Notify_Delete();
...
<template>
  <q-card>
    <q-card-section>
      <global_actions_header_buttons :index="true" :create="true"  route="task_types"></global_actions_header_buttons>
