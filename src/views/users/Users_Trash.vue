...
export default {
  ...
  methods: {
    ...mapActions([
      "Module_User_Action_Trash_Index",
      "Module_User_Action_Trash_Delete",
        "Module_User_Action_Restore"
    ]),
    Items_Get(per_page, page) {
      ...
      this.Module_User_Action_Trash_Index({per_page: per_page, page: page}).then(res => {
    ...
    Item_Delete(id) {
      ...
      this.Module_User_Action_Trash_Delete(id).then(res => {
...
<template>
  <q-card>
    <q-card-section>
      ...
      <global_actions_header_buttons :create="true" :index="true" route="users"></global_actions_header_buttons>
