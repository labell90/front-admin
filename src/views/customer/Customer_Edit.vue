  ...
  <q-card>
    ...
    <template v-else>
      <q-card-section>
        ...
        <q-btn :to="{name : 'customer_index'}" class="float-right" color="yellow-9" text-color="dark" icon="fas fa-backward" glossy label="بازگشت"></q-btn>
        <q-btn :to="{name : 'customer_create'}" class="float-right q-mr-sm" color="pink-7"  glossy icon="fas fa-plus-circle" label="افزودن آیتم جدید"></q-btn>
