...
export default {
  ...
  methods :{
    ...mapActions([
      "Module_Providers_Category_Index",
      "Module_Providers_Category_Delete",
    ...
    Items_Get(per_page,page){
      ...
      this.Module_Providers_Category_Index({per_page:per_page,page:page,params:this.query_params}).then(res => {
    ...
    Item_Delete(id){
      ...
      this.Module_Providers_Category_Delete(id).then(res => {
...
<template>
  <q-card>
    <q-card-section>
      <global_actions_header_buttons :create="true" :archive="true" route="providers_category"></global_actions_header_buttons>
        ...
        <template v-slot:body-cell-tools="props">
          <q-td :props="props">
            <div class="text-center">
              <q-btn :to="{name:'providers_category_edit',params:{id:props.row.id}}" glossy title="ویرایش آیتم" class="q-ma-xs" color="blue-8" icon="fas fa-edit" size="9px" round  />
