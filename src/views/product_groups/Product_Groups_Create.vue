...
export default {
  ...
  methods:{
    ...
    Create_Item(){
      this.loading=true;
      this.Module_Product_Groups_Create(this.items).then(response => {
        this.loading=false;
...
<template>
  ...
  <q-card>
      ...
      <q-card-section>
        <strong class="text-grey-10"> افزودن گروه بندی محصولات</strong>
        <global_actions_header_buttons :index="true" route="product_groups"></global_actions_header_buttons>
