...
export default {
  ...
  methods :{
    ...mapActions([
      "Module_Options_Trash_Index",
      "Module_Options_Restore_Delete",
      "Module_Options_Restore",
    ...
    Items_Get(per_page,page){
      ...
      this.Module_Options_Trash_Index({per_page:per_page,page:page}).then(res => {
    ...
    Item_Delete(id){
      ...
      this.Module_Options_Restore_Delete(id).then(res => {
    ...
    Item_Restore(id){
      this.delete_loading=true;
      this.Module_Options_Restore(id).then(res => {
        this.items = this.items.filter(item => {
          return item.id !== id;
        })
        this.Methods_Notify_Delete();
