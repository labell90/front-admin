...
export default {
  ...
  methods :{
    ...
    Item_Delete(id){
      ...
      this.Module_Lead_Resource_Action_Delete(id).then(res => {
        ...
        <template v-slot:body-cell-tools="props">
          <q-td :props="props">
            <div class="text-center">
              <q-btn :to="{name:'lead_resources_edit',params:{id:props.row.id}}" glossy title="ویرایش آیتم" class="q-ma-xs" color="blue-8" icon="fas fa-edit" size="11px" round  />
