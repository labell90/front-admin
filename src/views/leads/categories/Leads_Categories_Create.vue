...
export default {
  ...
  methods:{
    ...mapActions([
      "Module_Lead_Category_Action_Create"
    ]),
    Create_Item(){
      this.loading=true;
      this.Module_Lead_Category_Action_Create(this.items).then(response => {
        this.loading=false;
...
<template>
  ...
  <q-card>
    <q-card-section>
      ...
      <global_actions_header_buttons :index="true"  route="lead_categories"></global_actions_header_buttons>
