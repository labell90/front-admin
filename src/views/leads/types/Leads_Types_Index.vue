...
export default {
  ...
  methods :{
    ...
    Items_Get(per_page,page){
      ...
      this.Module_Lead_Types_Action_Index({per_page:per_page,page:page,params:this.query_params}).then(res => {
...
<template>
  ...
  <q-card>
    <q-card-section>
      <global_actions_header_buttons :create="true" :archive="true" route="lead_types"></global_actions_header_buttons>
