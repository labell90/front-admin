...
export default {
  ...
  methods :{
    ...mapActions([
      "Module_Opportunities_Action_Index",
    ...
    Items_Get(per_page,page){
      ...
      this.Module_Opportunities_Action_Index({per_page:per_page,page:page,params:this.query_params}).then(res => {
    ...
    Searchable_Get(){
      this.Module_Opportunities_Searchable().then(res => {
    ...
    Item_Delete(id)
    {
      ...
      this.Module_Opportunities_Action_Delete(id).then(res => {
...
<template>
  ...
  <q-card>
    <q-card-section>
      <global_actions_header_buttons :create="true" :archive="true" route="opportunities"></global_actions_header_buttons>
          ...
          <q-td :props="props">
            <div class="row q-pt-xs q-pb-xs" >
              <template  v-if="props.row.client_group">
                ...
                <strong :style="'color:'+props.row.customers.color_code">{{props.row.client_group.name}}</strong>
        ...
        <template v-slot:body-cell-tools="props">
          <q-td :props="props">
            <div class="text-center">
              <q-btn :to="{name:'opportunities_edit',params:{id:props.row.id}}" glossy title="ویرایش آیتم" class="q-ma-xs" color="blue-8" icon="fas fa-edit" size="9px" round  />
