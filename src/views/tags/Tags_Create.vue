...
export default {
  ...
  methods:{
    ...
    Create_Item(){
      this.loading=true;
      this.Module_tags_Create(this.items).then(response => {
        this.loading=false;
...
<template>
  <q-card>
    <q-card-section>
      <strong class="text-grey-10">افزودن تگ جدید</strong>
      <q-btn :to="{name : 'tags_index'}" class="float-right" color="blue-8"  glossy icon="fas fa-list" label="لیست موارد"></q-btn>
