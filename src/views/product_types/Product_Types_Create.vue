...
export default {
  ...
  methods:{
    ...mapActions([
      "Module_Product_Types_Create"
    ]),
    Create_Item(){
      this.loading=true;
      this.Module_Product_Types_Create(this.items).then(response => {
        this.loading=false;
...
<template>
  ...
  <q-card>
    <q-card-section>
      <strong class="text-grey-10"> افزودن نوع محصولات</strong>
      <global_actions_header_buttons :index="true" route="product_types"></global_actions_header_buttons>
