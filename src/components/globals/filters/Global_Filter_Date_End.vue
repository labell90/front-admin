...
<template>
<!--  <q-btn color="blue" label="test" @click="Change"></q-btn>-->
  <q-chip v-if="final_date" dir="ltr" color="red-7" text-color="white" size="sm" class="cursor-pointer">
